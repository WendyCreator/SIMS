            ...
            <div class="row">
               <div class="col-lg-8">
                  ...
                  if(isset($_GET['blog_title'])){
                    $blog = str_replace('-', ' ', $_GET['blog_title']);
                  // $blog = $conn->real_escape_string($_POST['blog_id']);
                     $blog = $conn->query("SELECT * FROM blog WHERE dtitle='$blog'");
                     ...
                     <div class="single-blog">
                        <div class="blog-image">
                           <a href="blog?blog_title=<?php echo $blog_title; ?>">
                           <img src="_slide_blog/<?php echo $row['dimg']; ?>" alt="blog image" />
                           </a>
                        </div>
                       
                        <div class="blog-text">
                           <h3><a href="blog?blog_title=<?php echo $blog_title; ?>"><?php echo $row['dtitle']; ?></a></h3>
                     ...
                     <div class="single-blog">
                        <div class="blog-image">
                           <a href="blog?blog_title=<?php echo $blog_title; ?>" class='post-ref'>
                           <img src="_slide_blog/<?php echo $row['dimg']; ?>" alt="blog image" />
                           </a>
                           <form action="" method="post">
                               <input type="hidden" name="blog_id" value=<?php echo $row['dblog_id'] ?>>
                               <input type="submit" value="submitPost" class='postId'>
                             </form>
                        </div>
                        <div class="blog-text">
                           <h3><a href="blog?blog_title=<?php echo $blog_title; ?>" class='post-ref'><?php echo $row['dtitle']; ?></a></h3>
                           ...
                           <a href="blog?blog_title=<?php echo $blog_title; ?>" class="gauto-btn">read more</a>
                           <form action="" method="post">
                               <input type="hidden" name="blog_id" value=<?php echo $row['dblog_id'] ?>>
                               <input type="submit" value="submitPost" class='postId'>
                             </form> 
                        ...
                        <?php 
                           ...
                           <li>
                              ...
                              <div class="recent-text">
                                 <h4>
                                 <a href="blog?blog_title=<?php echo $blog_title; ?>"><?php echo $row['dtitle']; ?></a>
                                 </h4>
                              </div>
                           </li>
                           <?php endwhile; ?>
