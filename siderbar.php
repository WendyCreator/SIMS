...
<div data-simplebar class="h-100">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                <a href="dashboard-saas.php" class="waves-effect">
...
<!-- 
            ...
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <span key="t-contacts">View All</span>
                </a>
                <ul class="sub-menu" aria-expanded="false">
                       <?php if($_SESSION['role'] == 'admin'){?>
                     <li><a href="staff-view.php" key="t-user-grid">View Staffs</a></li>
                     <?php } ?>
                    <li><a href="student-view.php" key="t-user-list">View Students</a></li>
                    <li><a href="contacts-profile.php" key="t-profile">View My Profile</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    <!-- <li><a href=<?php #echo ($_SESSION['role'] == 'admin')?"auth-register.php":'#' ?> key="t-register">Register Staff</a></li> -->
                    <!-- <li><a href="auth-register-2.php" key="t-register-2">Register 2</a></li> -->
                    <?php if($_SESSION['role'] == 'admin'){?>
                     <li><a href="auth-register.php" key="t-register">Register Staff</a></li>
                     <?php } ?>
                    <li><a href="register-student.php" key="t-recover-password">Enrol Students</a></li>
                    <?php if($_SESSION['role'] == 'admin'){?>
                        <li><a href="add-school.php" key="t-recover-password-2">Register School</a></li>
                     <?php } ?>
                    <li><a href="auth-recoverpw.php" key="t-recover-password">Reset Password</a></li>
                    ...
                    <li><a href="auth-confirm-mail.php" key="t-confirm-mail">Confirm Email</a></li>
                    <!-- <li><a href="auth-confirm-mail-2.php" key="t-confirm-mail-2">Confirm Email 2</a></li> -->
...
<li>
    <a href="calendar-full.php" class="waves-effect">
