                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Student Information Management System (SIMS) </h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <img src="<?php echo ($_SESSION['image'] != 'no image')?$_SESSION['image']:'assets/images/users/avatar-1.jpg' ?>" alt="" class="avatar-md rounded-circle img-thumbnail">
                                                    </div>
                                                    <div class="flex-grow-1 align-self-center">
                                                        <div class="text-muted">
                                                            <p class="mb-2">Welcome to <?php echo $_SESSION['username'] ?> Dashboard</p>
                                                            <h5 class="mb-1"><?php echo $_SESSION['fullname'] ?></h5>
                                                            <p class="mb-0"><?php echo $_SESSION['school'] ." " . $_SESSION['role'] ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
